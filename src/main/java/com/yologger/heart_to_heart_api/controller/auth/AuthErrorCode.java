...
public enum AuthErrorCode {
    ...
    INVALID_REFRESH_TOKEN(400, "AUTH_007", "Invalid Refresh Token"),
    EXPIRED_REFRESH_TOKEN(400, "AUTH_008", "Expired Refresh Token"),

    BEARER_NOT_INCLUDED(400, "AUTH_009", "'Authorization' header must start with 'Bearer"),
    INVALID_ACCESS_TOKEN(400, "AUTH_010", "Invalid Access Token"),
    EXPIRED_ACCESS_TOKEN(400, "AUTH_011", "Expired Access Token"),
    ;
